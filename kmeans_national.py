...
# Read state data
confirm_by_state = pd.read_csv("data/UW time series/global 11-8-21/United States by county/US_state_confirmed_sm.csv")
death_by_state = pd.read_csv("data/UW time series/global 11-8-21/United States by county/US_state_deaths_sm.csv")
